...
class zkSwap(SwapOperator):
    ...
    def __init__(self, acc, swap_token, gas_for_approve = 0.25, gas_for_swap=0.4, slippage=0.3):
        ...
        self.router_contract = self.get_contract(ZK_ZKSWAP_CONTRACTS['router'], ZKSWAP_ROUTER_ABI)
    ...
    def swap_to_eth(self, amount):
        nonce = self.check_token_approval(ZK_ZKSWAP_CONTRACTS['router'], amount)
